                ...
                <div class="row">
                    <div class="col p-4">
                        <div class="input-lanjutan">
                            ...
                            <div class="header">
                                <div class="form-group d-flex align-items-center">
                                    <label for="kota" class="mr-3 ml-1" class="mr-2" style="width: 130px;">Kota</label>
                                    <input type="text" class="form-control w-25" name="kota" id="kota" placeholder="Kota" readonly>
                                </div>
                                <div class="form-group d-flex align-items-center">
                                    <label for="propinsi" class="mr-3 ml-1" class="mr-2" style="width: 130px;">Propinsi</label>
                                    <input type="text" class="form-control w-25" name="propinsi" id="propinsi" placeholder="Propinsi" readonly>
                                </div>
                                <div class="form-group d-flex align-items-center">
                                    <label for="kodepos" class="mr-3 ml-1" class="mr-2" style="width: 130px;">Kodepos</label>
