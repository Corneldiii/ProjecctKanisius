    ...
    <div id="content">
        ...
        <div class="container-fluid">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 class="h3 mb-0 text-gray-800">Detail dan Update Memo</h1>
            </div>
            ...
            <form class="user" id="updateMasuk" action="<?= site_url("insert") ?>" method="post">
                    ...
                    <div class="col-8">
                        ...
                        <div class="header p-3">
                            <div class="form-group d-flex align-items-center">
                                <label for="nomorSurat" class="mr-0.5" style="width: 150px;">Nomor Memo</label>
                            ...
                            <div class="form-group d-flex align-items-center">
                                ...
                                <input type="date" style="width: 200px;" class="form-control text-start" name="tanggal" id="tanggal" readonly>
                            </div>
                            <div class="form-group d-flex align-items-center">
                ...
                <div class="header p-3">
                    ...
                    <div class="form-group d-flex align-items-center">
                        <label for="nomorSuratFisik" class="mr-0.5" style="width: 150px;">Nomor Fisik Memo</label>
                        <input type="text" class="form-control text-left w-25" name="nomorSuratFisik" id="nomorSuratFisik" placeholder="Nomor Fisik Surat">
                    </div>
                    <div class="form-group d-flex align-items-center">
                        <label for="tanggalSurat" class="mr-0.5" style="width: 150px;">Tanggal Memo</label>
